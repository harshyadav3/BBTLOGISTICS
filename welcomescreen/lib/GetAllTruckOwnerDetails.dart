...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'Get All TruckOwner Screen',
      theme: ThemeData(
        primarySwatch: Colors.blue,
      ),
      home: TruckOwnerScreen(),
    );
  }
}
class  TruckOwnerScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Get All TruckOwners Screen'),
      ),
      body: Center(
        child: Column(
          ...
          children: <Widget>[
            Text(
              'Hi, Welcome To Get All TruckOwners Screen',
              ...
              onPressed: () async {
               /* Navigator.push(
                ...
                // Perform register button action
                  ...
                  String str ='http://localhost:3000/getallTruckOwners';
    ...
    String str ='http://localhost:3000/getalltruckowner';
    var url = Uri.parse(str);
    if (await canLaunchUrl(url))
    {
          await launchUrl(url);
